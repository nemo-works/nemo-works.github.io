...
export const alkooWorks: AlkooWorkItem[] = [
  {
    ...
    listTitle: "日陰ルート機能",
    listDescription:
      "日陰を通る量を日陰率と地図上の日陰で視覚化。\nユーザーにとって最適なルートを比較・検討しやすい機能で、グッドデザイン賞受賞。",
    thumbnail: {
      src: "/img/alkoo-top/containts-02.png",
      alt: "日陰ルート機能",
    },
    href: "/detail/alkoo/shade-route",
    tags: ["UIUX", "機能検討", "展示"],
  },
  {
    id: "walk-route",
    ...
    thumbnail: {
      src: "/img/alkoo-top/containts-03.png",
      alt: "散歩ルート機能",
    },
  ...
  /*   {
    ...
    listTitle: "月間レポート",
    listDescription:
      "ユーザーのお出かけをキャラクターと一緒にふりかえり。\n1ヶ月の移動を「思い出」に感じられるあたたかなサービスイメージをコンテンツで表現。",
    thumbnail: {
      src: "/img/monthly-report/img_contents_alkoo_manth_report.jpg",
      alt: "レポート機能",
    },
